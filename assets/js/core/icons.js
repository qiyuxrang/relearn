/* ============================================================
   SVG 图标库（Lucide 风格线性图标，24x24 网格）
   ============================================================ */
...
const ICON_PATHS = {
  ...
  stepF:       '<path d="M6 4h2v16H6z"/><path d="m10 4 10 8-10 8V4z"/>',
  stepB:       '<path d="M16 4h2v16h-2z"/><path d="M14 4 4 12l10 8V4z"/>',
  reset:       '<path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/>',
  shuffle:     '<path d="m18 14 4 4-4 4"/><path d="m18 2 4 4-4 4"/><path d="M2 18h1.973a4 4 0 0 0 3.3-1.7l5.454-8.6a4 4 0 0 1 3.3-1.7H22"/><path d="M2 6h1.972a4 4 0 0 1 3.6 2.2"/><path d="M22 18h-6.041a4 4 0 0 1-3.3-1.8l-.359-.45"/>',
  toEnd:       '<path d="m4 4 10 8-10 8V4z"/><path d="M18 4h2v16h-2z"/>',
 ...
 * @param {number} size  尺寸（px），默认由 CSS 控制
 */
export function icon(name, size) {
  const p = ICON_PATHS[name];
  if (!p) return '';
  const dim = size ? ` width="${size}" height="${size}"` : '';
  return `<svg${dim} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${p}</svg>`;
}

export const hasIcon = (name) => Boolean(ICON_PATHS[name]);
